# thank you to whatotter for this code
# https://github.com/whatotter/pwnhyve/blob/main/core/bettercap/bettercap.py
...
def decode(r):
    try:    
        ...
        if r.status_code == 200:
            print("error while decoding json: error='%s' resp='%s'" %
                   (e, r.text))
        else:
    ...
    def _wait_bettercap(self):
        for x in range(5):
            try:
                ...
                print("bettercap avaialble")
                return True
            except Exception:
                print("waiting for bettercap API to be available ...")
                sleep(1)
        return False
